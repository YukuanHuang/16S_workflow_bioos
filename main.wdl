...
import "./tasks/tasks_qiime2.wdl" as qiime2 
...
workflow amplicon16S {
    ...
    if(input_format == "SingleEndFastqManifestPhred33V2"){
        call qiime2.qiime2_tools_import_se {
            input:
        ...
        call qiime2.qiime2_cutadapt_trim_single {
            input:
        ...
        call qiime2.qiime2_dada2_denoise_single {
            input: 
    ...
    if(input_format == "PairedEndFastqManifestPhred33V2"){
        call qiime2.qiime2_tools_import_pe {
            input:
                input_fastqs = input_fastqs,
        ...
        call qiime2.qiime2_cutadapt_trim_paired {
            input:
        ...
        call qiime2.qiime2_dada2_denoise_paired {
            input: 
    ...
    call qiime2.align_to_tree_mafft_fasttree {
        input:
    ...
    call qiime2.qiime2_tabulate_min_max{
        input:
            table = qiime_filter.filtered_table,
            qiime2_docker_image = qiime2_docker_image
    }
    call qiime2.qiime2_diversity_core{
        input:
            metadata = metadata,
    ...
    call qiime2.qiime2_export_for_picurst2{
        input:
            representative_seqs_qza = qiime_filter.filtered_seqs,
            representative_table_qza = qiime_filter.filtered_table,
            qiime2_docker_image = qiime2_docker_image
